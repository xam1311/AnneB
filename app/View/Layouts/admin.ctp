...
<head>
	...
	<?php
		...
		echo $this->fetch('css');	
		echo $this->Html->css(array('//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css','back/jquery-ui-1.10.3.custom.min','back/jquery.fancybox','back/main.css'));
		echo $this->Html->script(array('http://ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js','//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js','back/jquery-ui-1.10.3.custom.min','back/jquery.fancybox.pack'));?>
