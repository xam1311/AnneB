...
<div class="item <?php if($thumbID && $media['id'] === $thumbID): ?>thumb<?php endif; ?>
<?php if($sliderID && $media['id']=== $sliderID): echo 'slider'; endif; ?>
<?php if($thumbnailID && $media['id']=== $thumbnailID): echo 'thumbnail'; endif; ?>">

		<input type="hidden" value="<?php echo $media['position']; ?>" name="data[Media][<?php echo $media['id']; ?>]">
		<?php if($thumbID && $media['id'] === $thumbID): ?><span class="badge">A la une</span><?php endif; ?>
		<?php if($sliderID && $media['id']=== $sliderID): ?><span class="badge">Slider</span><?php endif; ?>
		<?php if($thumbnailID && $media['id']=== $thumbnailID): ?><span class="badge">Thumbnail</span><?php endif; ?>
		<div class="visu">

		<?php echo $this->Html->image($media['icon']); ?></div>
		...
		<div class="actions">
			...
			<?php endif; ?>
			<?php if($sliderID !== false && $media['id'] !== $sliderID && $media['type'] == 'pic'): ?>
			   <?php echo $this->Html->link(__d("media", "Utiliser cette image pour slider"),array('action'=>'slider',$media['id'])); ?> -
			<?php endif; ?>
			<?php if($thumbnailID !== false && $media['id'] !== $thumbnailID && $media['type'] == 'pic'): ?>
			   <?php echo $this->Html->link(__d("media", "Utiliser cette image pour Thumbnail"),array('action'=>'thumbnail',$media['id'])); ?> -
			<?php endif; ?>
